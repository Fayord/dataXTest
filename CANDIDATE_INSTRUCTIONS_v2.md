...
**Time limit:** You have 2 weeks from receiving this assignment to submit your solution.
...
- **Public Git repository** - push your work to your own public GitHub (or other Git hosting) repository and share the link with us.
- **Archive file** - send us a `.zip` or `.tar.gz` archive of the project. Make sure the `.git` folder is included so we can review your commit history.

## Deliverables

1. All code changes committed with clear, meaningful commit messages.
